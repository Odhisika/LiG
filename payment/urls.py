...
urlpatterns = [
    ...
    path('initialize/<int:order_id>/<str:gateway>/', views.initialize_payment, name='initialize_payment_gateway'),
    path('verify/', views.verify_payment, name='verify_payment'),
    path('webhook/', views.paystack_webhook, name='paystack_webhook'),
    path('webhook/hubtel/', views.hubtel_webhook, name='hubtel_webhook'),
